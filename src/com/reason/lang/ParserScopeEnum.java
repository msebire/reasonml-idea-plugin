...
public enum ParserScopeEnum {
    ...
    variantConstructor, variantConstructorParameter, variantConstructorParameters, typeBinding, signatureScope, recordFieldAnnotation, signatureParams, option, optionParameter, name
}

...
public class OclTypes extends ORTypes {
    ...
    private OclTypes() {
        ...
        C_EXCEPTION_EXPR = new ORCompositeElementType("C_EXCEPTION_EXPR", OclLanguage.INSTANCE);
        ...
        C_WITH_EXPR = new ORCompositeElementType("C_WITH_EXPR", OclLanguage.INSTANCE);
